...
public static class MboLifecycleProbeArtifactWriter
{
    ...
    public static string BuildFileName(string? instrument, DateTime utc, Guid sessionId)
    {
        ...
        return $"MboLifecycleProbe_{SanitizeInstrument(instrument)}_{ts}_{sessionId.ToString("N")[..8]}.json";
    }

    public static ArtifactWriteResult WriteAtomic(MboLifecycleProbeSnapshot snapshot, string? directory = null)
    {
