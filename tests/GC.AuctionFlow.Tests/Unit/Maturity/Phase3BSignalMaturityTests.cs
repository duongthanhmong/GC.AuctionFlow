...
public sealed class Phase3BSignalMaturityTests
{
    ...
    /// <summary>
    /// A resolvable location so these tests exercise lifecycle mapping rather than the
    /// Phase 3D location gate. Gate behaviour is owned by Phase3DLocationGateTests.
    /// </summary>
    ...
    [Fact]
    public void J01_SnapshotVersion_is_0_24_0() =>
    ...
    [Fact]
    public void K01_GpsCard_has_21_diagnostic_rows()
    {
